...
void AC4ECharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void AC4ECharacter::SetHasRifle(bool bNewHasRifle)
{
	bHasRifle = bNewHasRifle;
}

bool AC4ECharacter::GetHasRifle()
{
	return bHasRifle;
}